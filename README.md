...
- **截屏翻译**：快捷键（默认 `Alt+W`，可自定义）呼出选区遮罩，框选屏幕区域后截图直接交给视觉模型，识别与翻译一步完成，表格、代码、复杂排版都能理解（需模型支持图片输入，如 gpt-5.5、qwen-vl-max、glm-4.5v）
...
| 模型 | 如 `gpt-5.5`、`deepseek-chat`、`qwen-plus`、`glm-5` |
